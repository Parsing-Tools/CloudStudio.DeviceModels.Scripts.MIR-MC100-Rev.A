...
# Configuration Script – MIR-MC100 - Rev. A

This **Configuration** script is designed for the **MIR-MC100** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – MIR-MC100 Rev. A

Este script de **Configuration** está diseñado para el modelo **MIR-MC100** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
